...
TITLES = {
    ...
    CB2_1_RAIF: "Райффайзен Банк - Дебетовая карта #ВсеСразу ❌",
    ...
    CB3_3_RAIF: "Райффайзен Банк - кредитная карта ◼",
...
def get_base_inline_keyboard_2():
    keyboard = [
        [
          InlineKeyboardButton(TITLES[CB2_1_RAIF], callback_data=CB2_1_RAIF),
        ],
        [
...
def get_base_inline_keyboard_3():
    keyboard = [
        ...
        [
          InlineKeyboardButton(TITLES[CB3_3_RAIF], callback_data=CB3_3_RAIF),
        ],
        [
